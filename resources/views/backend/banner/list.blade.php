            ...
            <div class="content-body">
                ...
                <section class="app-user-list">
                    ...
                    <div class="card">
                       ...
                       <a href="{{route('banner.show')}}">Add New Banner</a>
                                    ...
                                    @foreach ($data as $key=>$item)
                                        <tr>
                                            ...
                                            @else
                                                InActive
                                            @endif</th>
                                            <th><img src="{{asset('banner').'/'.$item->image}}" style="height: 250x;width:250px;"></th>
                                            <th><a href="{{route('banner.delete',$item->id)}}">Delete</a>|<a href="{{route('banner.edit',$item->id)}}">Edit</a></th>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
