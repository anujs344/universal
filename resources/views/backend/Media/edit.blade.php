                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" method="POST" action="{{route('media.update')}}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" id="first-name" class="form-control" name="url" value="{{$data->url}}"placeholder="http://youtube.com/" />
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="status">
                                                            <option value="{{$data->status}}">@if ($data->status)
                                                                Yes
                                                            @else
                                                                No
                                                            @endif</option>
