            ...
            <div class="content-body">
                ...
                <section class="app-user-list">
                    ...
                    <div class="card">
                       ...
                       <a href="{{route('category.show')}}">Add New Category</a>
                                ...
                                <tbody>
                                    @foreach ($data as $key=>$item)
                                        <tr>
                                            ...
                                            <th><img src="{{asset('category').'/'.$item->image}}" style="height: 250px;width:250px"></th>
                                            <th><a href="{{route('category.delete',$item->id)}}">Delete</a>|<a href="{{route('category.edit',$item->id)}}">Edit</a></th>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
