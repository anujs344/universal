            ...
            <div class="content-body">
                ...
                <section class="app-user-list">
                    ...
                    <div class="card">
                       ...
                       <a href="{{route('careercategory.show')}}">Add New Career Category</a>
                                ...
                                <tbody>
                                    @foreach ($data as $key=>$item)
                                        <tr>
                                            ...
                                            <th>{{$item->name}}</th>
                                            {{-- {{$item->id}} --}}
                                            <th><a href="{{route('careercategory.delete',$item->id)}}">Delete</a>|<a href="{{route('careercategory.edit',$item->id)}}">Edit</a></th>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
