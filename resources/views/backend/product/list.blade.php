                                ...
                                <tbody>
                                    @foreach ($data as $key=>$item)
                                        <tr>
                                            ...
                                            <th><img src="{{asset('product').'/'.$item->image}}"" style="height:100px;width:100px"></th>
                                            <th><a href="{{route('product.delete',$item->id)}}">Delete</a>|<a href="{{route('product.edit',$item->id)}}">Edit</a></th>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
